...
class ToolController extends Controller
{
    ...
    public function guardar_solicitud(Request $request)
    {
        ...
        Mail::to('juan.hortua@unillanos.edu.co')->send(new MailSolicitud(
          $user->name,
          $user->email,
          $tool->nombre,
          $x->pivot->created_at,
    ...
    public function entregar(Request $request)
    {
        ...
        Mail::to('juan.hortua@unillanos.edu.co')->send(new MailEntrega(
          $request->user()->name,
          $tool->nombre,
    ...
    public function aprobar(Request $request)
    {
        ...
        Mail::send('emails.solicitud_respuesta',$data, function($message){
            $message->to('juan.hortua@unillanos.edu.co','juan hortua')->subject('Solicitud de elemento aprobada');
        }); */
      ...
      Mail::to('juan.hortua@unillanos.edu.co')->send(new MailRespuesta(
        ...
        $users = $tool->users()
             ...
             /*   
            Mail::send('emails.solicitud_respuesta',$data, function($message){
                $message->to('juan.hortua@unillanos.edu.co','juan hortua')->subject('Solicitud de elemento rechazada');
            }); */
